    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          {/* Logowanie Google wychodzi z aplikacji i wraca na /auth/callback, gdzie
              nie ma juz parametrow z tego adresu. Cel zapisujemy wiec na czas
              wycieczki do Google, zeby uzytkownik wrocil tam, skad go wyproszono,
              a nie na sztywna strone startowa. */}
          <Button variant="outline" className="w-full" onClick={() => {
            try { sessionStorage.setItem('rm_powrot_po_logowaniu', redirectTo); } catch { /* tryb prywatny */ }
            loginWithGoogle();
          }}>
