...
export default function ZgodaCookies() {
  ...
  return (
    <div
      ...
      // Ponad wszystkim, co plywa nad trescia: przycisk nawigacji (z-1400) i
      // pomoc (z-1300) nachodzily na przyciski zgody, a przelacznik stylu
      // zaslanial "Tylko to, co niezbedne". Wybor zgody musi byc zawsze klikalny.
      className="fixed inset-x-0 bottom-0 z-[1500] border-t border-border bg-card shadow-token-lg
